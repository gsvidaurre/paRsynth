...
write_audio <- function(df, sylLen = 200, sampling_rate = 200000, smoothing = list(interpol = "loess", loessSpan = 1, discontThres = 0, jumpThres = 0), rolloffExact = c(0.25, 0.25, 0.25, 0.25, 0.25), formants = NA, vocalTract = NA, temperature = 0, subratio = 2, vibratoFreq = 1, prefix = "IndividualSignatures", save_path) {
