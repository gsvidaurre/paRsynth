...
synthetic_call_metadata <- na.omit(synthetic_call_metadata)
...
<br>
![Example Spectrogram of GroupMembership_Group1_Ind1_Call1](/Users/gretheljuarez/Desktop/BIRDS/paRsynth_methods_synthetic_dataset/images/GroupMembership_Group1_Indiv1_Call1.jpeg)
...
Now, we are getting to the key analysis step. Using warbleR, a spectrographic cross-correlation (SPCC) can be performed to find acoustic similarities between the spectrograms created. 
...
ggsave("GroupMembership.png", plot = GroupMembership, width = 6, height = 4, dpi = 300)
