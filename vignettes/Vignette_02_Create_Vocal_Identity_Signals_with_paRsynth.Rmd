...
synthetic_call_metadata %>%
  write.csv(., file = file.path(analysis_path, "GI-RV-II_synthetic_call_metadata.csv"), row.names = FALSE) #TKTK do we want store the metadata with both data sets in the analysis_path for its appropriate string_structure_path
...
synthetic_call_metadata <- read.csv(file.path(analysis_path, "GI-RV-II_synthetic_call_metadata.csv")) #TKTK do we want store the metadata with both data sets in the analysis_path for its appropriate string_structure_path
