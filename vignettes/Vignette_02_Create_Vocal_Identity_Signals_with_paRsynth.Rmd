...
After running this code you will have two datasets combined into a single CSV: 1) reflects vocalizations with more group information than individual and 2) vice versa. Navigate to Vignette 03: Bioacoustics Analysis to learn how to analyze these outputs you created with paRsynth. Or if you would like to learn more about how to create vocal identity signals with paRsynth using different frequency anchors setting and understanding how the spectrogram gets affected check out Vignette 02b: Effects of Different Frequency Anchors Settings on Spectrogram.
