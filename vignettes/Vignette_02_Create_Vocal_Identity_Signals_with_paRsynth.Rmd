...
synthetic_call_metadata1 <- write_audio(
  ...
  shortestEpoch = 300, 
  vibratoFreq = 1,
  save_path = audio_path[2], # Make sure the audio_path matches the string_structure set to be saved in the appropriate directory
...
synthetic_call_metadata1 %>%
  write.csv(., file = file.path(string_structure_path[2], "synthetic_call_metadata1.csv"), row.names = FALSE) # Make sure to set to the appropriate string_structure_path
...
synthetic_call_metadata2 %>%
  write.csv(., file = file.path(string_structure_path[2], "synthetic_call_metadata2.csv"), row.names = FALSE) # Make sure to set to the appropriate string_structure_path
...
synthetic_call_metadata2 <- read.csv(file.path(string_structure_path[2], "synthetic_call_metadata2.csv"))
...
group <- read.csv("/Users/gretheljuarez/Desktop/BIRDS/paRsynth_methods_synthetic_dataset/GI-RV-II/synthetic_call_metadata1.csv")

individual <- read.csv("/Users/gretheljuarez/Desktop/BIRDS/paRsynth_methods_synthetic_dataset/GI-RV-II/synthetic_call_metadata2.csv")
...
synthetic_call_metadata %>%
  write.csv(., file = file.path(string_structure_path[2], "GI-RV-II_synthetic_call_metadata.csv"), row.names = FALSE) #TKTK do we want store the metadata with both data sets in the analysis_path for its appropriate string_structure_path
...
synthetic_call_metadata <- read.csv(file.path(string_structure_path[2], "GI-RV-II_synthetic_call_metadata.csv")) #TKTK do we want store the metadata with both data sets in the analysis_path for its appropriate string_structure_path
