...
global_strings <- 8 # 4 characters for the global head, 4 for the global tail
...
Dataset_A <- read.csv("/Users/gretheljuarez/Desktop/BIRDS/paRsynth_methods_synthetic_dataset_copy/synthetic_call_metadata1_cf.csv")
Dataset_B <- read.csv("/Users/gretheljuarez/Desktop/BIRDS/paRsynth_methods_synthetic_dataset_copy/synthetic_call_metadata1_sf.csv")

# Combine the CSV files of each dataset
synthetic_call_metadata_cf_sf <- rbind(Dataset_A, Dataset_B)
