...
testing_path <- "/Users/Ollia/Downloads/BIRDS/GitHub_Repos/paRsynth/R" # Alexandra's testing path
...
path <- "/Users/Ollia/Downloads/BIRDS/paRsynthdata" # Alexandra's path
...
calls_parsons <- parsons_code(
  ...
  mapping = list("A" = "up", "B" = "down", "C" = "constant", "D"="double")
)
