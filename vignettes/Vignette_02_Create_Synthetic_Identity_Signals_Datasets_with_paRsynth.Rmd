...
After running this code you will have two datasets combined into a single .csv file. The first dataset reflects synthetic identity signals with more group information than individual and the 2nd dataset vice versa. Navigate to Vignette 03: Bioacoustics Analysis to learn how to analyze these outputs you created using the paRsynth functions.
